...
"[project]/vibe/error-saas/kubernetes/errors/k8s_errors.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const K8S_ERRORS = [
    {
        ...
        fix_steps: [
            {
                ...
                commands: [
                    "kubectl get secrets -o yaml  < /dev/null |  grep -A 5 tls",
            ...
            },
            {
                ...
                commands: [
                    ...
                    "kubectl create secret tls <tls-secret> --cert=new-cert.pem --key=new-key.pem"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/configuration/secret/",
        ...
        clarifying_questions: [
            "Which certificate is expired?",
            "Are you using cert-manager for automatic renewal?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            ...
            "Are there any specific error messages in autoscaler logs?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            ...
            "Is this internal pod-to-pod communication?"
        ],
        examples: [
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/services-networking/service/",
                        "label": "Service Port Configuration"
                    }
                ]
            }
        ],
    ...
    },
    {
        ...
        fix_steps: [
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/tasks/debug-application-cluster/debug-application/",
                        "label": "Debug Pods and ReplicationControllers"
                    }
                ]
            },
            {
        ...
        clarifying_questions: [
            "How long has the pod been in ContainerCreating state?",
            "Are there volume mounts configured?"
        ],
        examples: [
            {
                ...
                sources: [
                    {
                        ...
                        "label": "Dynamic Volume Provisioning"
                    }
                ]
            }
        ],
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                step: "Verify image availability",
                commands: [
                    "kubectl get pods -o yaml  < /dev/null |  grep image",
        ...
        clarifying_questions: [
            "How long has the pod been in ContainerCreating state?",
            "Are there any specific error messages in the events?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl config set-context --current --timeout=60s"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/reference/kubectl/overview/",
                        "label": "kubectl Overview"
                    }
                ]
            },
            {
        ...
        clarifying_questions: [
            "Is this affecting all kubectl operations?",
    ...
    },
    {
        ...
        clarifying_questions: [
            "What context are you trying to switch to?",
        ...
        fix_steps: [
            {
                ...
                commands: [
                    "kubectl get pods -n kube-system  < /dev/null |  grep coredns",
    ...
    },
    {
                ...
                sources: [
                    {
                        ...
                        "label": "Resource Usage Monitoring"
                    }
                ]
            },
            {
                ...
                commands: [
                    "kubectl get pod <pod-name> -o yaml  < /dev/null |  grep -A 5 resources"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
        ...
        clarifying_questions: [
            "What is the current CPU limit for the container?",
            "Is the application performance noticeably affected?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        root_causes: [
            ...
            },
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
                        "label": "Managing Resources for Containers"
                    }
                ]
            }
        ],
        ...
        clarifying_questions: [
            "What does the container exit code show?",
            "Are you seeing OOMKilled events?"
        ],
        examples: [
            {
                ...
                sources: [
                    {
                        ...
                        "label": "Define Environment Variables for Container"
                    }
                ]
            }
        ],
    ...
    },
    {
        ...
        clarifying_questions: [
            "What ConfigMaps or Secrets is the pod trying to use?",
            "Are there any volume mount errors?"
        ],
        examples: [
            {
    ...
    },
    {
                ...
                sources: [
                    {
                        ...
                        "label": "Pod Priority and Preemption"
                    }
                ]
            }
        ],
        fix_steps: [
            {
                ...
                commands: [
                    "kubectl get pods --all-namespaces  < /dev/null |  grep Pending",
                    "kubectl describe pods <pending-pod>"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/scheduling-eviction/kube-scheduler/",
        ...
        clarifying_questions: [
            ...
            "Are you using pod affinity or anti-affinity rules?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            ...
            "Are there large log files consuming space?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    ...
                    "kubectl get all --all-namespaces  < /dev/null |  grep -v Running"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/tasks/administer-cluster/configure-upgrade-etcd/",
        ...
        clarifying_questions: [
            "What is the current size of the etcd database?",
            "Are there any patterns in the data causing growth?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl get pod <pod-name> -o yaml  < /dev/null |  grep -A 5 volumes"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/storage/volumes/",
        ...
        clarifying_questions: [
            "What type of volume is failing to mount?",
            "What is the exact error message in the pod events?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "What scheduling constraints does the pod have?",
            "Are there any specific node requirements?"
        ],
        examples: [
            {
                ...
                sources: [
                    {
                        ...
                        "label": "RBAC Command Line Utilities"
                    }
                ]
            },
            {
                ...
                sources: [
                    {
                        ...
                        "label": "ServiceAccount Permissions"
                    }
                ]
            }
        ],
        clarifying_questions: [
            "What operation is being forbidden?",
                ...
                sources: [
                    {
                        ...
                        "label": "RBAC Resource References"
                    }
                ]
            }
        ],
    ...
    },
    {
        ...
        aliases: [
            "hpanotworking",
            "hpa not working",
            "horizontal pod autoscaler failed",
            "autoscaling failed"
        ],
        matchers: {
            regex: [
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl top pods",
                    "kubectl get apiservice  < /dev/null |  grep metrics"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/tasks/debug-application-cluster/resource-usage-monitoring/",
        ...
        clarifying_questions: [
            "What metrics is the HPA configured to use?",
            "Are pod resource requests defined?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl patch deployment <deployment> -p '{\"spec\":{\"template\":{\"spec\":{\"containers\":[{\"name\":\"<container>\",\"imagePullPolicy\":\"IfNotPresent\"}]}}}}'"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/containers/images/#image-pull-policy",
                        "label": "Pull Policy Configuration"
                    }
                ]
            },
            {
                ...
                sources: [
                    {
                        ...
                        "label": "Debugging Kubernetes nodes with crictl"
                    }
                ]
            }
        ],
        clarifying_questions: [
            "Is this a locally built image?",
            "What imagePullPolicy is configured?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            ...
            "What specific error are you seeing when accessing the application?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            {
                ...
                sources: [
                    {
                        "url": "https://docs.docker.com/engine/reference/commandline/tag/",
                        "label": "Docker Naming Convention"
                    }
                ]
            },
            {
        ...
        clarifying_questions: [
            "What is the exact image name being used?",
            "Are there any special characters in the image name?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "cat -A <yaml-file>",
                    "python -c \"import yaml; yaml.safe_load(open('<yaml-file>'))\""
                ],
                sources: [
                    {
                        "url": "https://yaml.org/spec/1.2/spec.html",
        ...
        clarifying_questions: [
            "What is the specific error message from kubectl?",
            "Which part of the YAML file is causing the issue?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/tasks/debug-application-cluster/debug-cluster/",
                        "label": "Troubleshooting Clusters"
                    }
                ]
            },
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/scheduling-eviction/node-pressure-eviction/",
                        "label": "Node Resource Management"
                    }
                ]
            },
            {
        ...
        clarifying_questions: [
            "Can you access the node directly?",
            "When did the kubelet last work?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl patch deployment <deployment-name> -p '{\"spec\":{\"template\":{\"spec\":{\"containers\":[{\"name\":\"<container-name>\",\"resources\":{\"requests\":{\"memory\":\"128Mi\"}}}]}}}}'"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
        ...
        clarifying_questions: [
            "What are the current LimitRange constraints in the namespace?",
            "What resource values is the pod trying to use?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl get pods -o=custom-columns=NAME:.metadata.name,MEMORY:.spec.containers[0].resources.limits.memory"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl config view --minify  < /dev/null |  grep namespace"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/",
        ...
        clarifying_questions: [
            "What is the exact namespace name being referenced?",
            "Was this namespace previously available?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "What specific network connection is failing?",
            "Are there any network policies in place?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "What hostname is failing to resolve?",
            "Is this a Kubernetes service or external hostname?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "Which node is experiencing disk space issues?",
            "What type of data is consuming the most space?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "Which specific node is not found?",
            "When did you last see the node available?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "How long has the node been NotReady?",
            "Are there any recent changes to the node?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "What storage class is the PVC requesting?",
            "Are there any available PVs that match the requirements?"
        ],
        examples: [
            {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/overview/working-with-objects/finalizers/",
                        "label": "Finalizer Management"
                    }
                ]
            }
        ],
        clarifying_questions: [
            "How long has the pod been terminating?",
            "Are there custom controllers involved?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl patch deployment <deployment-name> -p '{\"spec\":{\"template\":{\"spec\":{\"terminationGracePeriodSeconds\":60}}}}'"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/",
        ...
        clarifying_questions: [
            "Was this an expected pod termination?",
            "Is the application handling SIGTERM properly?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            ...
            "How much CPU/memory is the pod requesting?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    ...
                    "kubectl describe nodes  < /dev/null |  grep -A 5 Taints"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/",
        ...
        clarifying_questions: [
            "What specific scheduling constraint is failing?",
            "Are there any node selectors or tolerations defined?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl patch deployment <deployment-name> -p '{\"spec\":{\"template\":{\"spec\":{\"securityContext\":{\"runAsNonRoot\":true}}}}}'"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/policy/pod-security-policy/",
        ...
        clarifying_questions: [
            "What security constraints are being violated?",
            "Is the pod trying to run as privileged?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl get pod <pod-name> -o yaml  < /dev/null |  grep -A 5 nodeSelector",
                    "kubectl get nodes --show-labels"
                ],
                sources: [
                    {
        ...
        clarifying_questions: [
            ...
            "Are there any specific scheduling constraints configured?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            {
                ...
                commands: [
                    ...
                    "netstat -tulpn  < /dev/null |  grep <port>"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/services-networking/service/",
            ...
            },
            {
                ...
                commands: [
                    "kubectl patch service <service-name> -p '{\"spec\":{\"ports\":[{\"port\":8081}]}}'"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/services-networking/service/",
        ...
        clarifying_questions: [
            "Which port is conflicting?",
            "Are you using hostPort or NodePort?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl patch resourcequota <quota-name> -p '{\"spec\":{\"hard\":{\"requests.cpu\":\"4\"}}}'"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/policy/resource-quotas/",
        ...
        clarifying_questions: [
            "Which specific quota is being exceeded?",
            "What type of resources are causing the limit?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        clarifying_questions: [
            "What specific operation is being denied?",
            "Which user or service account is being used?"
        ],
        examples: [
            {
        ...
        fix_steps: [
            {
                ...
                commands: [
                    "kubectl describe pod <pod-name>",
                    "kubectl get pod <pod-name> -o yaml  < /dev/null |  grep -A 10 readinessProbe"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/",
    ...
    },
    {
        ...
        fix_steps: [
            {
                ...
                commands: [
                    "kubectl get secrets",
                    "kubectl get secrets --all-namespaces  < /dev/null |  grep <secret-name>"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/configuration/secret/",
        ...
        clarifying_questions: [
            "What is the name of the missing secret?",
            "In which namespace should the secret exist?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            {
                ...
                commands: [
                    ...
                    "kubectl get services --all-namespaces  < /dev/null |  grep <service-name>"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/services-networking/service/",
        ...
        clarifying_questions: [
            "What is the exact service name being referenced?",
            "In which namespace should the service exist?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            {
                ...
                commands: [
                    "kubectl describe pod <pod-name>",
                    "kubectl get pod <pod-name> -o yaml  < /dev/null |  grep -A 10 startupProbe"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/",
        ...
        clarifying_questions: [
            "What is the startup probe checking?",
            "How long does the application normally take to start?"
        ],
        examples: [
            {
                ...
                sources: [
                    {
                        ...
                        "label": "PKI certificates and requirements"
                    }
                ]
            }
        ],
                ...
                sources: [
                    {
                        ...
                        "label": "Certificate Management Best Practices"
                    }
                ]
            },
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/tasks/debug-application-cluster/debug-cluster/",
                        "label": "Debugging Clusters"
                    }
                ]
            }
        ],
        clarifying_questions: [
            "Is this happening during API server communication?",
    ...
    },
    {
                ...
                sources: [
                    {
                        ...
                        "label": "Controlling Access to Kubernetes API"
                    }
                ]
            }
        ],
        fix_steps: [
                ...
                sources: [
                    {
                        ...
                        "label": "Configure Access to Multiple Clusters"
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/reference/access-authn-authz/authentication/#putting-a-bearer-token-in-a-request",
        ...
        clarifying_questions: [
            "Are you using kubectl or in-cluster authentication?",
            "When did the credentials last work?"
        ],
        examples: [
            {
    ...
    },
    {
        ...
        fix_steps: [
            ...
            },
            {
                ...
                commands: [
                    "kubectl get storageclass",
                    "kubectl logs -n kube-system <csi-driver-pods>"
                ],
                sources: [
                    {
                        "url": "https://kubernetes.io/docs/concepts/storage/storage-classes/",
        ...
        clarifying_questions: [
            "What type of volume is failing to mount?",
            "Is this a new pod or existing one?"
        ],
        examples: [
            {
...
"[project]/vibe/error-saas/app/api/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$kubernetes$2f$errors$2f$k8s_errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/vibe/error-saas/kubernetes/errors/k8s_errors.ts [app-route] (ecmascript)");
...
class K8SearchEngine {
    ...
    ALIAS_MATCH_SCORE = 80;
    REGEX_MATCH_SCORE = 60;
    FUZZY_MATCH_SCORE = 40;
    CATEGORY_BOOST = 20;
    TITLE_BOOST = 15;
    SUMMARY_BOOST = 10;
    search(query, category, page = 1, pageSize = 20) {
        const startTime = Date.now();
        const normalizedQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$lib$2f$normalize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeText"])(query);
        if (!normalizedQuery) {
            return {
                results: [],
                total: 0,
        ...
        results.push(...this.findExactMatches(normalizedQuery));
        // 2. Alias matches
        results.push(...this.findAliasMatches(normalizedQuery));
        // 3. Regex pattern matches
        results.push(...this.findRegexMatches(normalizedQuery));
        // 4. Fuzzy content matches
        results.push(...this.findFuzzyMatches(normalizedQuery));
        // Remove duplicates by canonical_slug
        const uniqueResults = this.deduplicateResults(results);
        // Apply category filter
        const filteredResults = category ? uniqueResults.filter((r)=>r.error.category === category) : uniqueResults;
        ...
        const categories = [
            ...new Set(filteredResults.map((r)=>r.error.category))
        ];
        return {
    ...
    findExactMatches(query) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$kubernetes$2f$errors$2f$k8s_errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["K8S_ERRORS"].filter((error)=>error.canonical_slug === query).map((error)=>({
                error,
    ...
    findAliasMatches(query) {
        const results = [];
        for (const error of __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$kubernetes$2f$errors$2f$k8s_errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["K8S_ERRORS"]){
            for (const alias of error.aliases){
                ...
                if (normalizedAlias.includes(query) || query.includes(normalizedAlias)) {
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$lib$2f$normalize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeText"])(error.title).includes(query)) {
            ...
            for (const pattern of error.matchers.regex){
                try {
                    ...
                    if (regex.test(query)) {
                        ...
                        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$lib$2f$normalize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeText"])(error.summary).includes(query)) {
    ...
    findFuzzyMatches(query) {
        ...
        for (const error of __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$kubernetes$2f$errors$2f$k8s_errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["K8S_ERRORS"]){
            ...
            const normalizedText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$lib$2f$normalize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeText"])(searchableText);
            let matchCount = 0;
            ...
            if (matchCount > 0) {
                ...
                const titleWords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$lib$2f$normalize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeText"])(error.title).split(/\s+/);
                for (const word of queryWords){
    ...
    getSuggestions(query) {
        ...
        for (const error of __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$kubernetes$2f$errors$2f$k8s_errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["K8S_ERRORS"]){
            for (const alias of error.aliases){
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$lib$2f$normalize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeText"])(alias).includes(normalizedQuery)) {
        ...
        // Add matching titles
        for (const error of __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$kubernetes$2f$errors$2f$k8s_errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["K8S_ERRORS"]){
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$vibe$2f$error$2d$saas$2f$lib$2f$normalize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeText"])(error.title).includes(normalizedQuery)) {
...
async function GET(request) {
    try {
        ...
        const results = searchEngine.search(query, category, page, pageSize);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0cf1b4af._.js.map